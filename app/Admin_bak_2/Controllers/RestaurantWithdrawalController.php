...
class RestaurantWithdrawalController extends AdminController
{
     ...
     * @var string
     */
    protected $title = 'Kirana Store Withdrawals';
    ...
    protected function grid()
    {
        ...
        $grid->column('restaurant_id', __('Kirana Store'))->display(function($restaurant){
    ...
    protected function form()
    {
        ...
        if(!Admin::user()->isAdministrator()){
            ...
            $form->select('restaurant_id', __('Kirana Store'))->options($restaurants);
        }
