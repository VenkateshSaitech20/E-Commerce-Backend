...
class OrderStatusController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('status_for_restaurant', __('Status For Kirana Store'));
    ...
    protected function detail($id)
    {
        ...
        $show->field('status_for_restaurant', __('Status for Kirana Store'));
    ...
    protected function form()
    {
        ...
        $form->text('status_for_restaurant', __('Status For Kirana Store'));
