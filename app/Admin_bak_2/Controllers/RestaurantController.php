...
class RestaurantController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('restaurant_name', __('Kirana Store Name'));
        $grid->column('restaurant_image', __('Kirana Store Image'))->image();
        ...
        $filter->like('restaurant_name', __('Kirana Store Name'));
    ...
    protected function form()
    {
        ...
        $form->text('restaurant_name', __('Kirana Store Name'))->rules('required|max:150');
        $form->image('restaurant_image', __('Kirana Store Image'))->move('restaurants')->uniqueName()->rules('required');
        ...
        $form->text('restaurant_phone_number', __('Kirana Store Phone Number'))->rules(function ($form) {
