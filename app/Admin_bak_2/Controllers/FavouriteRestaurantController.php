...
class FavouriteRestaurantController extends AdminController
{
     ...
     * @var string
     */
    protected $title = 'Favourite Kirana Store';
    ...
    protected function grid()
    {
        ...
        $filter->equal('restaurant_id', __('Kirana Store'))->select($restaurants);
    ...
    protected function form()
    {
        ...
        $form->select('restaurant_id', __('Kirana Store'))->options($restaurants)->rules(function ($form) {
            return 'required';
        });
