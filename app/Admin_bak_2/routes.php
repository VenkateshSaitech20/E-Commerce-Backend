...
Route::group([
    ...
    $router->resource('kirana-stores', RestaurantController::class);
    $router->resource('kirana-store-timings', RestaurantTimingController::class);
    ...
    $router->resource('favourite-kirana-store', FavouriteRestaurantController::class);
    ...
    $router->resource('kirana-store-notifications', RestaurantNotificationController::class);
    ...
    $router->resource('kirana-store-settings', RestaurantSettingController::class);
    ...
    $router->resource('kirana-store-cuisines', RestaurantCuisineController::class);
    $router->resource('kirana-store-earnings', RestaurantEarningController::class);
    $router->resource('kirana-store-wallet-histories', RestaurantWalletHistoryController::class);
    $router->resource('kirana-store-withdrawals', RestaurantWithdrawalController::class);
    $router->resource('delivery-boy-app-settings', DeliveryBoyAppSettingController::class);
    $router->resource('kirana-store-app-settings', RestaurantAppSettingController::class);
    ...
    $router->resource('kirana-store-categories', RestaurantCategoryController::class);
    $router->resource('customer-complaints', CustomerComplaintController::class);
