...
class DeliveryBoyEarningController extends AdminController
{
     ...
     * @var string
     */
    protected $title = 'Delivery Partner Earnings';
    ...
    protected function grid()
    {
        ...
        $grid->column('delivery_boy_id', __('Delivery Partner'))->display(function($delivery_boy_id){
        ...
        $grid->filter(function ($filter) {
            ...
            $filter->equal('delivery_boy_id', 'Delivery Partner')->select($delivery_boys);
        });
    ...
    protected function form()
    {
        ...
        $form->text('order_id', __('Order'));
        $form->select('delivery_boy_id', __('Delivery Partner'))->options($delivery_boy)->rules(function ($form) {
            return 'required';
        });
