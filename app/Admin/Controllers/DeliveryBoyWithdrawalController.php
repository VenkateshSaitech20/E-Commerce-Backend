...
class DeliveryBoyWithdrawalController extends AdminController
{
     ...
     * @var string
     */
    protected $title = 'Delivery Partner Withdrawals';
    ...
    protected function grid()
    {
        ...
        $grid->column('delivery_boy_id', __('Delivery Partner'))->display(function($delivery_boy){
    ...
    protected function form()
    {
        ...
        $form->select('delivery_boy_id', __('Delivery Partner'))->options($delivery_boys)->rules(function ($form) {
                return 'required';
            });
